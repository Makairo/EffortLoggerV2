...
public class SQLInjectionHandling {
	...
	*/
	...
	//the above will be done when we have a proper SQL DB to cover using Prepared Statements.

	//For now,the test will simply iterate over string inputs and declare if they are fit or not
